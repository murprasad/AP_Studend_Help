...
export async function POST(req: NextRequest) {
  try {
    ...
    if (allQuestions.length < questionCount) {
      ...
      // Rotate through units and difficulties for variety
      ...
      if (generated.length > 0) {
        ...
        aiGenerationWarning = `${generated.length} question${generated.length === 1 ? "" : "s"} generated by AI and added to your session.`;
