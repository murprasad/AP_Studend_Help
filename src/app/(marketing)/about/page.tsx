    ...
    <div className="max-w-3xl mx-auto px-4 py-16 space-y-16 text-center">
      ...
      <div className="space-y-6">
        <div className="text-center space-y-1">
          ...
          <p className="text-sm text-muted-foreground">A landing-page rebuild driven by real student feedback (&ldquo;feels like another AI study tool&rdquo;) plus a complete restructure of how courses are gated. Hero now demos a real wrong-answer flow on its own. CLEP/DSST handed off to PrepLion. Course visibility is now a per-bank quality gate (≥200 vetted questions before users see it). And a permanent E2E guard blocks the React-error class that surfaced the &ldquo;hiccup&rdquo; fallback page from ever shipping again.</p>
        </div>
