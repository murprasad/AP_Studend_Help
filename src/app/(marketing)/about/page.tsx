    ...
    <div className="max-w-3xl mx-auto px-4 py-16 space-y-16 text-center">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Badge className="bg-blue-500/20 text-blue-800 dark:text-blue-400 border-blue-500/30 text-xs font-semibold">Beta 11.4</Badge>
          </div>
        </div>
      ...
      <div className="space-y-6">
        <div className="text-center space-y-1">
          ...
          <h2 className="text-xl font-bold">What&apos;s New in Beta 11.4</h2>
          <p className="text-sm text-muted-foreground">SAT=CB parity complete: scaled 200-800 section scores, 2-module routing with Module-2 tier feeding the scaled-score band, Desmos embed in Math, RW digital-format copy, domain subscores on mock-exam result, Khan Academy skill-links on wrong answers, and weighted sampling. Plus ACT parity (Conventions content gap closed), full activation overhaul (journey compression, minimal dashboard), Pass Ready certification + Today&apos;s Set (Readiness-focused dashboard hero), CB-style landing rebuild for /ap //sat //act //psat, Capacitor Android wrap, SMS/Twilio + Web Push re-engagement, and 31 CB cb-spec files covering all visible courses.</p>
        </div>
        <div className="grid sm:grid-cols-2 gap-3 text-left">
          {[
            { icon: Sparkles, color: "text-blue-500", bg: "bg-blue-500/10", title: "All 29 courses at ≥500 questions, all visible", desc: "Every AP, SAT, and ACT course we serve now has 500+ vetted MCQs in the bank — silver tier (passed deterministic gates + source-attributed). AP_BIOLOGY leads at 1,820. AP_ENGLISH_LITERATURE 1,016. SAT_READING_WRITING 968. 7 courses that previously weren&apos;t visible (because banks were thin) are now on the sidebar: AP English Lit, AP English Lang, AP Euro, AP Physics 1, AP Calc AB, AP Precalc, SAT Reading &amp; Writing." },
            { icon: Brain, color: "text-blue-500", bg: "bg-blue-500/10", title: "4-source content pipeline", desc: "Bank fill no longer depends on AI generation alone. We extract questions from OpenStax AP-aligned textbooks (CC BY 4.0), ground new questions in Project Gutenberg public-domain passages (Twain, Austen, Dickens, Federalist Papers), and use AP Course &amp; Exam Descriptions as content scaffolds for STEM/math gen. Every question carries source attribution: sourceBook, sourceUrl, sourceLicense." },
      ...
      <div className="space-y-6">
        ...
        <div className="grid sm:grid-cols-2 gap-3 text-left">
          {[
            ...
            { icon: LayoutDashboard, color: "text-blue-500", bg: "bg-blue-500/10", title: "Pricing Copy Cleanup", desc: "All remaining &ldquo;per module&rdquo; references replaced with all-access language across FAQ, JSON-LD schema, and Sage&rsquo;s system prompt. CLEP content lives on preplion.ai." },
