...
export const metadata: Metadata = {
  title: "ACT Prep â€” AI Practice for All 4 Sections | StudentNest Prep",
...
const courses = [
  { name: "ACT Math", units: 5, desc: "Pre-algebra through trigonometry â€” 5 choices per question" },
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-16 space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <div className="text-center lg:text-left space-y-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold">
            Boost your ACT score 3+ points â€” focus on what actually matters.
          </h1>
          <p className="text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0">
            Math, English, Science, Reading â€” Sage adapts to each section and drills you where it matters most.
          </p>
      ...
      <div className="space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="lg:order-2 space-y-3">
            ...
            <h2 className="text-2xl font-bold">Real ACT format â€” including 5-choice Math</h2>
            <p className="text-muted-foreground leading-relaxed">Section-specific questions with real ACT format (Aâ€“E for Math). Instant AI explanations for every answer, every mistake.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">See per-section scores and overall composite improve as you practice. Build ACT pacing instincts â€” 60s/question Math, 36s English.</p>
          </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { icon: Brain, title: "Section-Specific Tutoring", desc: "Sage knows the difference between ACT Science reasoning and ACT Reading â€” and tutors accordingly." },
          { icon: Target, title: "Real ACT Format", desc: "5-choice Math (Aâ€“E), not 4. Every question matches the actual ACT format exactly." },
          { icon: BarChart3, title: "Composite Tracking", desc: "See per-section scores and overall composite improve as you practice." },
          { icon: Clock, title: "Build ACT Pacing", desc: "Practice at real ACT speed â€” 60s/question Math, 36s English. Build instincts for test day." },
        ].map((f) => (
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            { week: "Weeks 2â€“3", task: "Math + English with pacing drills" },
            { week: "Weeks 4â€“5", task: "Science + Reading with timed practice" },
      ...
      <div className="rounded-xl border border-border/40 bg-card/50 p-6 text-center space-y-2">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed max-w-xl mx-auto">
          Practice covers all 4 ACT sections with real exam formatting and pacing. Your child gets targeted practice on their weakest sections, composite score tracking, and a structured study plan â€” for a fraction of tutoring costs.
        </p>
      </div>
