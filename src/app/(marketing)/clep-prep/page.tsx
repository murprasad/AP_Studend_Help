...
export default function ClepPrepPage() {
  return (
    <div className="space-y-0">
      ...
      {/* ═══ EASIEST CLEP EXAMS — #1 SEO target ═══ */}
      <section id="easiest" className="max-w-5xl mx-auto px-4 py-16 scroll-mt-20">
        ...
        <div className="text-center mt-6">
          <Link href="/register?module=clep">
            <Button className="gap-2 bg-emerald-600 hover:bg-emerald-700">Start with the Easiest Exam <ArrowRight className="h-4 w-4" /></Button>
          </Link>
        </div>
      </section>
      ...
      {/* ═══ EXAM READINESS — feature preview with mockup ═══ */}
          ...
          <FadeIn>
            <div className="space-y-4 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-center lg:items-start pt-2">
                <Link href="/register?module=clep">
                  <Button className="gap-2 bg-emerald-600 hover:bg-emerald-700">See My Readiness Score <ArrowRight className="h-4 w-4" /></Button>
                </Link>
              </div>
            </div>
          </FadeIn>
      ...
      {/* ═══ SCHEDULE ANYTIME — year-round advantage ═══ */}
      ...
      {/* ═══ ALL 34 EXAMS — domain-grouped accordion ═══ */}
      <section className="max-w-5xl mx-auto px-4 py-16">
        <FadeIn>
      ...
      {/* ═══ WHAT IS CLEP? — for confused beginners ═══ */}
      <section className="bg-secondary/20 py-14">
      ...
      <section className="bg-gradient-to-t from-emerald-500/[0.06] to-transparent py-16">
        <div className="max-w-3xl mx-auto px-4 text-center space-y-5">
          <FadeIn>
            ...
            <p className="text-xs text-muted-foreground/60">Free to start · No credit card · Cancel anytime</p>
          </FadeIn>
        </div>
      </section>
