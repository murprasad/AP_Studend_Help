  ...
  AP_PHYSICS_1: {
    ...
    units: {
      ...
      PHY1_2_FORCES_AND_NEWTONS_LAWS: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=ap%20forces%20newtons%20laws",
      ...
      PHY1_3_CIRCULAR_MOTION_GRAVITATION: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=ap%20centripetal%20force%20and%20gravitation",
      ...
      PHY1_4_ENERGY: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=ap%20work%20and%20energy",
      ...
      PHY1_5_MOMENTUM: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=ap%20impulse%20and%20momentum",
      ...
      PHY1_6_SIMPLE_HARMONIC_MOTION: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=ap%20simple%20harmonic%20motion",
      ...
      PHY1_7_TORQUE_AND_ROTATION: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=ap%20torque%20and%20angular%20momentum",
  ...
  AP_STATISTICS: {
    ...
    units: {
      ...
      STATS_7_INFERENCE_MEANS: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=inference%20quantitative%20univariate",
      ...
      STATS_9_INFERENCE_SLOPES: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=inference%20slope%20ap",
  ...
  AP_US_HISTORY: {
    ...
    units: {
      ...
      APUSH_9_PERIOD_1980_PRESENT: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=us%20history%20overview",
  ...
  AP_PSYCHOLOGY: {
    ...
    units: {
      PSYCH_1_SCIENTIFIC_FOUNDATIONS: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=history%20and%20approaches%20to%20psychology%20ap",
      ...
      PSYCH_2_BIOLOGICAL_BASES: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=biological%20bases%20of%20behavior%20ap",
      ...
      PSYCH_3_SENSATION_PERCEPTION: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=sensation%20perception%20ap",
      ...
      PSYCH_4_LEARNING: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=learning%20ap",
      ...
      PSYCH_5_COGNITION: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=memory%20ap",
      ...
      PSYCH_6_DEVELOPMENTAL: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=developmental%20psychology%20ap",
      ...
      PSYCH_7_MOTIVATION_EMOTION: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=motivation%20and%20emotion%20ap",
      ...
      PSYCH_8_CLINICAL: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=psychological%20disorders%20ap",
      ...
      PSYCH_9_SOCIAL: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=social%20psychology%20ap",
...
- FRQs are hand-scored — rubric-aligned thesis + specific textual evidence + sophisticated complexity earn the 6`,
  ...
  SAT_MATH: {
    ...
    curriculumContext: "Digital SAT Math (since March 2024) — 44 questions across two 35-minute adaptive modules. ~75% multiple-choice (4 options) + ~25% student-produced response (SPR/grid-in). Covers Algebra, Advanced Math, Problem-Solving & Data Analysis, and Geometry & Trigonometry.",
    tutorResources: "• Khan Academy SAT Math (khanacademy.org/sat) — official CB partner\n• College Board Bluebook (bluebook.collegeboard.org) — official practice tests + the actual test-day app",
    examAlignmentNotes: "Digital SAT Math: a calculator IS permitted throughout the entire Math section, and a built-in Desmos graphing calculator is provided on every question on the real test. (Updated from paper-SAT legacy 2026-05-31 — F3 of SAT=CB parity sprint.)",
  ...
  SAT_READING_WRITING: {
    ...
    curriculumContext: "Digital SAT Reading & Writing (since March 2024) — 54 questions across two 32-minute adaptive modules. 100% multiple-choice (4 options). Every question pairs with a single short passage (1-2 paragraphs). Covers Craft & Structure, Information & Ideas, Standard English Conventions, and Expression of Ideas.",
    tutorResources: "• Khan Academy SAT Reading (khanacademy.org/sat) — official CB partner\n• College Board Bluebook (bluebook.collegeboard.org) — official practice tests + the actual test-day app",
    examAlignmentNotes: "Digital SAT Reading & Writing: every question is paired with a 1-2 paragraph passage and is fully answerable from that passage alone. Module 1 is mixed difficulty; Module 2 difficulty adapts based on Module 1 performance. Focus on evidence-based reasoning. (Updated 2026-05-31 — F5 of SAT=CB parity sprint.)",
  ...
  CLEP_COLLEGE_COMPOSITION: {
    ...
    units: {
      CLEP_COMP_1_ESSAY_STRATEGIES: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=writing",
      },
      CLEP_COMP_2_RHETORICAL_ANALYSIS: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=welcome%20to%20ap%20lang",
      },
      CLEP_COMP_3_RESEARCH_DOCUMENTATION: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=style%20and%20usage",
      },
  ...
  CLEP_INTRO_PSYCHOLOGY: {
    ...
    units: {
      ...
      CLEP_PSY_5_CLINICAL_ABNORMAL: {
        ...
        openStaxUrl: "https://openstax.org/books/psychology-2e/pages/15-introduction",
        khanUrl: "https://www.khanacademy.org/search?page_search_query=clinical%20psychology%20ap",
      },
    },
    suggestedTutorQuestions: [
      "What is the difference between classical and operant conditioning?",
  ...
  CLEP_PRINCIPLES_OF_MARKETING: {
    ...
    units: {
      ...
      CLEP_MARKETING_2_CONSUMER_BEHAVIOR: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=consumer%20theory",
      },
      ...
      CLEP_MARKETING_5_DIGITAL_GLOBAL: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=international%20trade%20topic",
      },
    },
    suggestedTutorQuestions: [
  ...
  CLEP_INTRODUCTORY_SOCIOLOGY: {
    ...
    units: {
      CLEP_SOC_1_SOCIOLOGICAL_PERSPECTIVE: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=theories%20of%20socialization",
      },
  ...
  DSST_PERSONAL_FINANCE: {
    ...
    units: {
      ...
      DSST_PF_4_INSURANCE_RISK: {
        ...
        openStaxUrl: "https://openstax.org/books/principles-finance/pages/1-why-finance",
        khanUrl: "https://www.khanacademy.org/search?page_search_query=pf%20insurance",
      },
      DSST_PF_5_RETIREMENT_ESTATE: {
        ...
        openStaxUrl: "https://openstax.org/books/principles-finance/pages/1-why-finance",
        khanUrl: "https://www.khanacademy.org/search?page_search_query=pf%20retirement",
      },
    },
    suggestedTutorQuestions: [
  ...
  DSST_MANAGEMENT_INFO_SYSTEMS: {
    ...
    units: {
      ...
      DSST_MIS_3_NETWORKS_SECURITY: {
        ...
        openStaxUrl: "https://openstax.org/books/introduction-business/pages/13-introduction",
        khanUrl: "https://www.khanacademy.org/search?page_search_query=internet%20intro",
      },
  ...
  DSST_SUBSTANCE_ABUSE: {
    ...
    units: {
      DSST_SA_1_PHARMACOLOGY: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=drug%20use",
      },
      DSST_SA_2_ALCOHOL: {
  ...
  DSST_ART_WESTERN_WORLD: {
    ...
    units: {
      DSST_ART_1_ANCIENT_MEDIEVAL: {
        ...
        openStaxUrl: "https://openstax.org/books/introduction-philosophy/pages/8-introduction",
        khanUrl: "https://www.khanacademy.org/search?page_search_query=ancient%20mediterranean%20702",
      },
  ...
  DSST_ASTRONOMY: {
    ...
    units: {
      DSST_ASTR_1_SOLAR_SYSTEM: {
        ...
        khanUrl: "https://www.khanacademy.org/search?page_search_query=solar%20system%20topic",
      },
  ...
  DSST_COMPUTING_AND_IT: {
    ...
    units: {
      DSST_CIT_1_HARDWARE_SOFTWARE: {
        ...
        openStaxUrl: "https://openstax.org/books/introduction-business/pages/13-introduction",
        khanUrl: "https://www.khanacademy.org/search?page_search_query=how%20computers%20work2",
      },
...
100 MCQ in 120 min. 4-choice format. ~400/500 passing. Earns 3 semester hours.`,
  ...
  AP_EUROPEAN_HISTORY: {
    ...
    enrichWithEduAPIs: true,
    units: {
      EURO_1_RENAISSANCE_EXPLORATION: { name: "Unit 1: Renaissance and Exploration", timePeriod: "1450–1648 CE", keyThemes: ["Italian Renaissance", "Northern Renaissance", "Age of Exploration"] },
      EURO_2_AGE_OF_REFORMATION: { name: "Unit 2: Age of Reformation", timePeriod: "1517–1648 CE", keyThemes: ["Protestant Reformation", "Catholic Counter-Reformation", "religious wars"] },
      EURO_3_ABSOLUTISM_CONSTITUTIONALISM: { name: "Unit 3: Absolutism and Constitutionalism", timePeriod: "1648–1715 CE", keyThemes: ["French absolutism", "English constitutionalism", "Eastern European states"] },
      EURO_4_SCIENTIFIC_PHILOSOPHICAL_POLITICAL: { name: "Unit 4: Scientific, Philosophical, and Political Developments", timePeriod: "1648–1789 CE", keyThemes: ["Scientific Revolution", "Enlightenment", "Enlightened absolutism"] },
      EURO_5_CONFLICT_LATE_18TH_CENTURY: { name: "Unit 5: Conflict, Crisis, and Reaction in the Late 18th Century", timePeriod: "1789–1815 CE", keyThemes: ["French Revolution", "Napoleonic Era", "Congress of Vienna"] },
      EURO_6_INDUSTRIALIZATION: { name: "Unit 6: Industrialization and Its Effects", timePeriod: "1815–1914 CE", keyThemes: ["Industrial Revolution", "social changes", "ideologies"] },
      EURO_7_19TH_CENTURY_PERSPECTIVES: { name: "Unit 7: 19th-Century Perspectives and Political Developments", timePeriod: "1815–1914 CE", keyThemes: ["nationalism", "imperialism", "Romanticism"] },
      EURO_8_20TH_CENTURY_GLOBAL_CONFLICTS: { name: "Unit 8: 20th-Century Global Conflicts", timePeriod: "1914–1945 CE", keyThemes: ["WWI", "interwar period", "WWII", "Holocaust"] },
      EURO_9_COLD_WAR_CONTEMPORARY: { name: "Unit 9: Cold War and Contemporary Europe", timePeriod: "1945–Present", keyThemes: ["Cold War", "decolonization", "European integration"] },
    },
