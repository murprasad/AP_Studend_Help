        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xl font-bold text-blue-500">{deltaLabel} today</p>
              <p className="text-xs text-muted-foreground mt-0.5">
                Projected: <span className="font-medium text-foreground">{beforeLabel}</span> → <span className="font-medium text-blue-500">{projectedLabel}</span>
              </p>
            </div>
          </div>
