  ...
  return (
    <div className="flex items-center gap-4 p-5 rounded-xl border border-emerald-500/20 bg-emerald-500/[0.03]">
      ...
      <button
        ...
        className="px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white text-sm font-medium transition-colors flex-shrink-0 flex items-center gap-2"
      >
