...
const faqs = [
  {
    q: "Is it really free?",
    a: "Yes. Free accounts get unlimited MCQ practice across all 22 courses, 5 AI tutor chats per day, a basic study plan, and per-unit mastery analytics. No credit card required, no time limit.",
  },
  {
  ...
  },
  {
    ...
    a: "10 AP courses (World History, Calculus AB/BC, Physics 1, Chemistry, Biology, Statistics, US History, Psychology, Computer Science), SAT Math & Reading/Writing, 4 ACT sections (Math, English, Science, Reading), and 6 CLEP exams.",
  },
  {
