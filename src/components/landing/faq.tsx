...
function buildFaqs(clepOn: boolean, dsstOn: boolean) {
  ...
  return [
    {
      q: "Is it really free?",
      a: `Yes. Free accounts get unlimited MCQ practice across all ${courseCount} courses, 3 Sage Live Tutor chats per day, a basic study plan, and per-unit mastery analytics. No credit card required, no time limit.`,
    },
    {
