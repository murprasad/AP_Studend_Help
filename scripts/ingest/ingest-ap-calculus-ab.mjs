// Ingest OFFICIAL AP Calculus AB FRQ content from College Board PDFs.
// Usage: node scripts/ingest/ingest-ap-calculus-ab.mjs
...
const COURSE = "AP_CALCULUS_AB";
const RAW_DIR = "data/raw/ap-calculus-ab";
...
const SOURCES = [
  ...
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap24-frq-calculus-ab.pdf",
    ], year: 2024, label: "2024" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap23-frq-calculus-ab.pdf",
    ], year: 2023, label: "2023" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap22-frq-calculus-ab.pdf",
    ], year: 2022, label: "2022" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap21-frq-calculus-ab.pdf",
    ], year: 2021, label: "2021" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap19-frq-calculus-ab.pdf",
...
async function ingestSet(source) {
  ...
  // Calc FRQs are short (4-6 questions), minLen lower.
  const prompts = genericFrqParse(fullText, { minLen: 120, maxQ: 7 });
