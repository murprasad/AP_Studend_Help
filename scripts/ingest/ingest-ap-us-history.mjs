// Ingest OFFICIAL AP US History FRQ content from College Board PDFs.
// Parses SAQs (Section I Part B) and DBQ + LEQs (Section II).
// Usage: node scripts/ingest/ingest-ap-us-history.mjs
...
const COURSE = "AP_US_HISTORY";
const RAW_DIR = "data/raw/ap-us-history";

// APUSH is always published as Set 1 + Set 2.
const SOURCES = [
  { candidates: ["https://apcentral.collegeboard.org/media/pdf/ap25-frq-us-history-set-1.pdf"],
    year: 2025, label: "2025 Set 1" },
  { candidates: ["https://apcentral.collegeboard.org/media/pdf/ap25-frq-us-history-set-2.pdf"],
    year: 2025, label: "2025 Set 2" },
  { candidates: ["https://apcentral.collegeboard.org/media/pdf/ap24-frq-us-history-set-1.pdf"],
    year: 2024, label: "2024 Set 1" },
  { candidates: ["https://apcentral.collegeboard.org/media/pdf/ap24-frq-us-history-set-2.pdf"],
    year: 2024, label: "2024 Set 2" },
  { candidates: ["https://apcentral.collegeboard.org/media/pdf/ap23-frq-us-history-set-1.pdf"],
    year: 2023, label: "2023 Set 1" },
  { candidates: ["https://apcentral.collegeboard.org/media/pdf/ap23-frq-us-history-set-2.pdf"],
