// Ingest OFFICIAL AP Calculus BC FRQ content from College Board PDFs.
// Usage: node scripts/ingest/ingest-ap-calculus-bc.mjs
...
const COURSE = "AP_CALCULUS_BC";
const RAW_DIR = "data/raw/ap-calculus-bc";
...
const SOURCES = [
  ...
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap24-frq-calculus-bc.pdf",
    ], year: 2024, label: "2024" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap23-frq-calculus-bc.pdf",
    ], year: 2023, label: "2023" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap22-frq-calculus-bc.pdf",
    ], year: 2022, label: "2022" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap21-frq-calculus-bc.pdf",
    ], year: 2021, label: "2021" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap19-frq-calculus-bc.pdf",
