// Ingest OFFICIAL AP Chemistry FRQ content from College Board PDFs.
// Usage: node scripts/ingest/ingest-ap-chemistry.mjs
...
const COURSE = "AP_CHEMISTRY";
const RAW_DIR = "data/raw/ap-chemistry";
...
const SOURCES = [
  ...
  // Older chemistry URLs appear to be gone from CB; we'll rely on 2023-2025.
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap22-frq-chemistry.pdf",
      "https://apcentral.collegeboard.org/media/pdf/ap-chemistry-frq-2022.pdf",
    ], year: 2022, label: "2022" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap21-frq-chemistry.pdf",
    ], year: 2021, label: "2021" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap19-frq-chemistry.pdf",
      "https://apcentral.collegeboard.org/media/pdf/ap-chemistry-frq-2019.pdf",
