// Ingest OFFICIAL AP Biology FRQ content from College Board PDFs.
// Usage: node scripts/ingest/ingest-ap-biology.mjs
...
const COURSE = "AP_BIOLOGY";
const RAW_DIR = "data/raw/ap-biology";
...
const SOURCES = [
  ...
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap22-frq-biology.pdf",
    ], year: 2022, label: "2022" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap21-frq-biology.pdf",
    ], year: 2021, label: "2021" },
  { candidates: [
      "https://apcentral.collegeboard.org/media/pdf/ap19-frq-biology.pdf",
